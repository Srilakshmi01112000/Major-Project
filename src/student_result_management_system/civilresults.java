 ...
 * @author srila
 */
public class civilresults extends javax.swing.JFrame {

    /**
     * Creates new form civilresults
     */
    public civilresults() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Geology");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Mechanics");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setText("Geotechnology");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String Geo=jTextField3.getText();
        String Mechanic=jTextField4.getText();
        String Geotech=jTextField5.getText();
        ...
        try{
          Class.forName("com.mysql.cj.jdbc.Driver");  
            ...
            if(rs.next()){
                 st.executeUpdate("insert into civilresults (USN,Maths,Geology,Mechanics,Geotechnology) values('"+usn+"','"+maths+"','"+Geo+"','"+Mechanic+"','"+Geotech+"')");
                 JOptionPane.showMessageDialog(null,"Result is saved successfully");
                  setVisible(false);
                 new civilresults().setVisible(true);
            }
            else{
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        new Mechresults().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(civilresults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
