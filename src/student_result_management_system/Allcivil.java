 ...
 * @author srila
 */
public class Allcivil extends javax.swing.JFrame {

    /**
     * Creates new form Allcivil
     */
    public Allcivil() {
        initComponents();
    }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
       ...
       int row=jTable1.getSelectedRow();
            String id = jTable1.getModel().getValueAt(row,1).toString();
             String qry ="Delete from civilresults where USN='"+id+"'";
           
            PreparedStatement pst=con.prepareStatement(qry);
            pst.execute();
              Statement st=con.createStatement();
            ResultSet  rs=st.executeQuery("select * from civilresults");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Allcivil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
