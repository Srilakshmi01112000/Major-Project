...
public class CSEresults extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cloud computing");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Cyber Security");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Data Science");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String cloud=jTextField3.getText();
        String cyber=jTextField4.getText();
        ...
        try{
          Class.forName("com.mysql.cj.jdbc.Driver");  
            ...
            if(rs.next()){
                 st.executeUpdate("insert into CSEresults (USN,Maths,CloudComputing,CyberSecurity,DataScience) values('"+usn+"','"+maths+"','"+cloud+"','"+cyber+"','"+data+"')");
