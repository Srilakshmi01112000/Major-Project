 ...
 * @author srila
 */
public class Mechresults extends javax.swing.JFrame {

    /**
     * Creates new form Mechresults
     */
    public Mechresults() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Kinematics");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Machine Drawing");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String kinematics=jTextField4.getText();
        String machine=jTextField5.getText();
        ...
        try{
          Class.forName("com.mysql.cj.jdbc.Driver");  
            ...
            if(rs.next()){
                 st.executeUpdate("insert into Mechresults (USN,Maths,FluidMechanics,Kinematics,MachineDrawing) values('"+usn+"','"+maths+"','"+fluid+"','"+kinematics+"','"+machine+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mechresults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
